      ...
      <div className="container mx-auto max-w-8xl">
        ...
        <div className="text-center mb-20 sm:mb-24 md:mb-32 animate-fadeInUp">
          ...
          <p className="text-2xl sm:text-3xl md:text-4xl text-gray-600 mb-12 sm:mb-16 max-w-5xl mx-auto leading-relaxed font-light">
            Discover the latest in premium men's gym wear designed for peak performance.
          </p>
        </div>
        {loading ? (
          ...
          <div className="text-center py-24 sm:py-32 animate-fadeInUp">
            <div className="text-8xl sm:text-9xl mb-8">🏋️</div>
            <h3 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-800 mb-6">No New Arrivals Yet</h3>
            <p className="text-xl sm:text-2xl text-gray-600 mb-12">Check back soon for the latest gym wear!</p>
              ...
              >
                ...
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute top-6 left-6">
                    <span className="bg-gradient-to-r from-scars-red to-red-600 text-white px-4 py-2 rounded-full text-base font-bold shadow-xl animate-bounce-gentle">
                      NEW
                    </span>
                  </div>
